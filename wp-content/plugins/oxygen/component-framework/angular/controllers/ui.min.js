...
CTFrontendBuilderUI.controller("ControllerSlider",["$controller","$scope","$timeout","$interval",function(e,i,n,t){i.$parent.$on("iframe-init",function(e,n){jQuery("#ct-sidepanel").on("mousedown",".ct-sortable-slide",function(e){if(!(0<jQuery(e.target).parents(".ct-more-options-container").length)){var n=jQuery(this).closest(".ct-sortable-slider").attr("ng-attr-tree-id"),t=jQuery(this).index()-3;i.animateToSlide(n,t)}})}),i.$parent.addSlides=function(){var e=n(function(){i.iframeScope.waitOxygenTree(function(){i.iframeScope.addComponent("ct_slide",!1,!0),i.iframeScope.addComponent("ct_slide",!1,!0),i.iframeScope.addComponent("ct_slide",!1,!0)}),t.cancel(e)},0,!1)},i.$parent.animateToSlide=function(e,n){0<=n&&i.iframeScope.sliders[e].unslider("animate:"+n)},i.$parent.slideAdded=function(e,n){i.iframeScope.rebuildDOM(e);var t=i.iframeScope.getComponentById(n).closest("li").index();i.animateToSlide(e,t)}}]);