...
CTFrontendBuilder.controller("ControllerNavigation",["$scope","$parentScope","$http","$timeout",function(a,s,e,t){a.openFolders={},a.toggledNodes=[],a.calcDefaultComponentTitle=function(e,o){var t=a.niceNames[e.name];return"ct_reusable"==e.name?t+=" (post: "+e.options.view_id+")":"ct_woocommerce"==e.name&&(hookName=a.getWooCommerceHookNiceName(e.options.original.hook_name),t+=hookName),o||(t+=" (#"+e.id+")"),t},a.setComponentCategory=function(e,o,t){var r=a.findComponentItem(a.componentsTree.children,e,a.getComponentItem);r.options.ct_category===o?(delete r.options.ct_category,delete a.component.options[e].ct_category):(r.options.ct_category=o,a.component.options[e].ct_category=o),jQuery(t.target).closest(".ct-more-options-expanded").removeClass("ct-more-options-expanded")},a.openLoadFolder=function(e,o,t,r){a.experimental_components[o].fresh?(t&&angular.element(r.target).addClass("oxygen-small-progress"),a.getComponentsListFromSource(e,o,function(e){t&&(s.tabs.components=[],angular.element(r.target).removeClass("oxygen-small-progress")),a.openFolder(e,o),s.applyMenuAim()})):(t&&(s.tabs.components=[]),a.openFolder(e,o))},a.openFolder=function(e,o){a.closeAllFolders(),a.openFolders[e]=void 0===o||o,"categories-categories"===e&&(void 0!==a.libraryCategories&&null!==a.libraryCategories||(a.libraryCategories={},a.libraryPages={},a.getStuffFromSource(a.processLibraryStuff)));t(function(){jQuery(".oxygen-folder-"+e+" .ct-add-item-button-image",window.parent.document).each(function(){jQuery(this).attr("src",jQuery(this).data("src"))})},0,!1);s.applyMenuAim()},a.processLibraryStuff=function(e){var o=(e=JSON.parse(e)).items,t=(e.key,parseInt(e.next));if(o){var r=o.components;r&&_.each(r,function(e){var o=e.category;void 0===o&&(o="Other"),a.libraryCategories[o]=a.libraryCategories[o]||{},a.libraryCategories[o].slug=btoa(o).replace(/=/g,""),a.libraryCategories[o].contents=a.libraryCategories[o].contents||[],a.libraryCategories[o].contents.push(e)});var n=o.pages;n&&_.each(n,function(e){if("ct_template"!==e.type){var o=e.category;void 0===o&&(o="Other"),a.libraryPages[o]=a.libraryPages[o]||{},a.libraryPages[o].slug=btoa(o).replace(/=/g,""),a.libraryPages[o].contents=a.libraryPages[o].contents||[],a.libraryPages[o].contents.push(e)}})}a.getStuffFromSource(a.processLibraryStuff,t),s.applyMenuAim()},a.closeAllFolders=function(e){a.openFolders={}},a.isShowFolder=function(e){return!!a.openFolders[e]},a.hasOpenFolders=function(){return 0<Object.keys(a.openFolders).length}}]);
CTFrontendBuilder.controller("ControllerColumns",["$scope","$parentScope","$timeout",function(p,d,t){p.columns=[],p.emptyColumnsComponent=[],p.updateColumnsOnAdd=!0,p.setColumns=function(t,e){var n=e.children.length,o=p.columns[t]-n,c=e.children[n-1];if(0<o)for(var i=0;i<o;i++)p.addColumn(t);if(o<0)for(i=0;o<i;i--)p.removeColumn(c.id)},p.updateColumns=function(t){p.findComponentItem(p.componentsTree.children,t,p.setColumns)},p.addColumn=function(t){p.applyComponentDefaultOptions(p.component.id,"ct_column");var e="ct_column",n=p.getActiveComponent(),o=p.getComponentTemplate(e,p.component.id);column={id:p.component.id,name:e},p.findComponentItem(p.componentsTree.children,p.component.active.id,p.insertComponentToTree,column),p.updateColumnsOnAdd(n,o),p.component.id++,p.activateComponent(t,"ct_columns")},p.removeColumn=function(t){if(1==p.columns[p.component.active.parent.id])return alert("You can not delete the last column"),!1;p.columns[p.component.active.parent.id]--;var e=p.getComponentById(t),n=e.parent();p.updateColumnsOnRemove(n,e),p.findParentComponentItem(p.componentsTree,t,p.cutComponentFromTree)},p.updateColumnsOnRemove=function(t,e){p.log&&console.log("updateColumnsOnRemove()");var n=t[0].querySelectorAll(".ct-column");if(d.isActiveName("ct_div_block")){if(!d.isActiveParentName("ct_columns")&&!d.isActiveParentName("ct_new_columns"))return!1;n=jQuery(t).children(".ct-div-block"),componentName="ct_div_block"}else componentName="ct_column";if(0<n.length){var o=n.length-1,c=e[0].getAttribute("ng-attr-component-id"),i=parseFloat(p.getOption("width",c));e.remove();var l=!1;if(angular.forEach(n,function(t){var e=t.getAttribute("ng-attr-component-id"),n=parseFloat(p.getOption("width",e));if(!isNaN(n)){var o={};p.findComponentItem(p.componentsTree.children,e,p.getComponentActiveSelector,o),o.activeselector&&(l=!0)}}),l)return!1;angular.forEach(n,function(t){var e=t.getAttribute("ng-attr-component-id"),n=((n=parseFloat(p.getOption("width",e)))+i/o).toFixed(2);p.setOptionModel("width",n,e,componentName)}),p.cleanInsert(t)}"ct_div_block"==componentName?p.checkColumnsWidthSum(jQuery(t).children(".ct-div-block"),componentName):p.checkColumnsWidthSum(t[0].querySelectorAll(".ct-column"),componentName)},p.updateColumnsOnChange=function(n,t){if(!p.isEditing("class")){var e=p.getOption("width",n),o=t-parseFloat(e),c=p.getComponentById(n),i=c.parent(),l=i[0].querySelectorAll(".ct-column");if(!(100<parseFloat(e)||parseFloat(e)<0||""===e||isNaN(parseFloat(e)))){if(d.isActiveName("ct_div_block")){if(!d.isActiveParentName("ct_columns")&&!d.isActiveParentName("ct_new_columns"))return!1;l=jQuery(i).children(".ct-div-block"),componentName="ct_div_block"}else componentName="ct_column";p.log&&console.log("updateColumnsOnChange()",t,e);var a=c.next();if(a[0]||(a=c.prev()),!a[0])return!1;var r=a[0].getAttribute("ng-attr-component-id"),m=parseFloat(p.getOption("width",r));if(!isNaN(m)){if(o<0)if(m>Math.abs(o)){var u=(m+o).toFixed(2);p.setOptionModel("width",u,r,componentName)}else if(0<l.length){u=((100-e)/(l.length-1)).toFixed(2);angular.forEach(l,function(t){var e=t.getAttribute("ng-attr-component-id");e!=n&&p.setOptionModel("width",u,e,componentName)})}if(0<o){u=(m+o).toFixed(2);p.setOptionModel("width",u,r,componentName)}p.checkColumnsWidthSum(l,componentName,n)}}}},p.updateColumnsOnAdd=function(t,e){p.log&&console.log("updateColumnsOnAdd()");var n=t[0].querySelectorAll(".ct-column");if(0<n.length){var o=n.length,c=(angular.element(n[0]).parent()[0].offsetWidth,(100/(o+1)).toFixed(2)),i=!1;if(angular.forEach(n,function(t){var e=t.getAttribute("ng-attr-component-id"),n=parseFloat(p.getOption("width",e));if(!isNaN(n)){var o={};p.findComponentItem(p.componentsTree.children,e,p.getComponentActiveSelector,o),o.activeselector&&(i=!0)}}),i)return!1;angular.forEach(n,function(t){var e=t.getAttribute("ng-attr-component-id"),n=parseFloat(p.getOption("width",e));n=((100-c)/100*n).toFixed(2);p.setOptionModel("width",n,e,"ct_column")}),p.setOptionModel("width",c,p.component.id,"ct_column")}p.getInnerWrap(t).append(e),p.cleanInsert(t),p.checkColumnsWidthSum(t[0].querySelectorAll(".ct-column"))},p.checkColumnsWidthSum=function(t,e,n){if(void 0!==t&&!p.isEditing("class")&&(null==e&&(e="ct_column"),p.log&&console.log("checkColumnsWidthSum()",t,e),0<t.length)){var o=0;angular.forEach(t,function(t){var e;e=t.options?t.id:t.getAttribute("ng-attr-component-id");var n=parseFloat(p.getOption("width",e));isNaN(n)||(o+=n)});var c,i=parseFloat(100-o).toFixed(2);t[0]&&t[0].name==e?n==(c=jQuery(t).last()[0].id)&&(c=jQuery(t).last().prev()[0].id):n==(c=jQuery(t).last()[0].getAttribute("ng-attr-component-id"))&&(c=jQuery(t).last().prev()[0].getAttribute("ng-attr-component-id"));var l=parseFloat(p.getOption("width",c)),a=parseFloat(l)+parseFloat(i);if(isNaN(a))return;p.setOptionModel("width",a.toFixed(2),c,e)}},p.checkEmptyColumns=function(t){if(p.emptyColumnsComponent[t]=!1,p.findComponentItem(p.componentsTree.children,t,p.checkEmptyColumnsCallback),!p.emptyColumnsComponent[t])return"ct-columns-empty"},p.checkEmptyColumnsCallback=function(t,e,n){angular.forEach(e.children,function(t){t.children&&(p.emptyColumnsComponent[e.id]=!0)})}}]);
CTFrontendBuilder.controller("ControllerAJAX",["$scope","$parentScope","$http","$timeout",function(f,g,x,v){f.postsData=[],f.showErrorModal=function(e,o,t,r){var n="";n=e&&0<e?("string"==typeof o?"<h4>"+o+"</h4>":"")+"<p><strong>"+("string"==typeof t?t:"")+" "+e+"</strong></p><p>Your server returned a "+e+" error for the request to "+r+".</p><p><a href='http://oxygenbuilder.com/documentation/troubleshooting/troubleshooting-guide/' style='text-decoration: underline; color: #fff;' target='_blank'>Troubleshooting Guide &raquo;</a></p>":("string"==typeof o?"<h4>"+o+"</h4>":"")+"<p><strong>"+("string"==typeof t?t:"")+"</strong></p>",f.showNoticeModal("<div>"+n+"</div>")},f.savePage=function(a){a||g.showLoadingOverlay("savePage()"),g.disableContentEdit();var e={classes:f.classes,custom_selectors:f.customSelectors,style_sets:f.styleSets,style_folders:f.styleFolders,style_sheets:f.styleSheets,page_settings:f.pageSettingsMeta,global_settings:f.globalSettings,easy_posts_templates:f.easyPostsCustomTemplates,comments_list_templates:f.commentsListCustomTemplates,typekit_fonts:f.typeKitFonts,global_colors:f.globalColorSets,element_presets:f.elementPresets,preview:(f.previewType,f.template.postData.permalink),codemirror_theme:f.globalCodeMirrorTheme,codemirror_wrap:f.globalCodeMirrorWrap};f.googleFontsCache||(e.google_fonts_cache=f.googleFontsList),angular.forEach(f.activeSelectors,function(e,o){f.skipChanges=!0,f.findComponentItem(f.componentsTree.children,o,f.updateComponentActiveSelector,e)}),f.watchIntervalCallback(),f.skipChanges=!1;var o={params:e,tree:f.componentsTree};o=angular.toJson(o),e={action:"ct_save_components_tree",post_id:CtBuilderAjax.postId,nonce:CtBuilderAjax.nonce};(jQuery("body").hasClass("ct_inner")||jQuery("body",window.parent.document).hasClass("ct_inner"))&&(e.ct_inner=!0),x({url:f.getAJAXRequestURL(),method:"POST",params:e,data:o,transformResponse:!1}).success(function(o,t,e,r){try{var n;if(a)0!=(n=JSON.parse(o)).post_saved&&f.allSaved();else 0===(n=JSON.parse(o))?f.showErrorModal(0,"YOUR PAGE WAS NOT SAVED BECAUSE YOU ARE NOT LOGGED IN. Open a new browser tab and log back in to WordPress. Then attempt to save the page again."):0==n.post_saved?(console.log(o),f.showErrorModal(0,"Error occurred while saving. Please contact support.")):f.allSaved(),g.hideLoadingOverlay("savePage()")}catch(e){console.log(o),console.log(e),a||f.showErrorModal(t,"Error occurred while saving",e)}}).error(function(e,o,t,r){console.log(e,o),a||g.hideLoadingOverlay("savePage()")}).then(null,function(e){f.showErrorModal(e.status,"Error occurred while saving",e.statusText,e.config.url)})},f.updateComponentActiveSelector=function(e,o,t){o&&o.options&&(o.options.activeselector=t)},f.saveComponentAsView=function(a,e,s){var o={action:"ct_save_component_as_view",name:f.componentizeOptions.name,post_id:CtBuilderAjax.postId,nonce:CtBuilderAjax.nonce,block:s},i=s?"Block":"Re-usable part";if(e.constructor===Array)var t=e;else t=[e];x({url:f.stripURLProtocol(CtBuilderAjax.ajaxUrl),method:"POST",params:o,data:{id:0,name:"root",depth:0,children:t}}).success(function(e,o,t,r){if(g.hideLoadingOverlay("saveComponentAsView()"),0!=e){var n=s?"Manage Blocks in the WordPress admin at Oxygen &gt; Block Library.":"";f.showNoticeModal("<div>"+i+" '"+f.componentizeOptions.name+"' created. "+n+"</div>","ct-notice"),s||f.replaceReusablePart(a,e)}else f.showErrorModal(0,'Error occurred while saving "'+i+'".')}).error(function(e,o,t,r){console.log(e,o),g.hideLoadingOverlay("saveComponentAsView()")}).then(null,function(e){f.showErrorModal(e.status,'Error occurred while saving "'+i+'".',e.statusText,e.config.url)})},f.loadComponentsTree=function(s,i,l,c){f.log&&console.log("loadComponentsTree()",i,l,c),g.showLoadingOverlay("loadComponentsTree()"),void 0===i&&(i=CtBuilderAjax.postId);var e={action:"ct_get_components_tree",id:i,post_id:CtBuilderAjax.postId,nonce:CtBuilderAjax.nonce};jQuery("body").hasClass("ct_inner")&&(e.ct_inner=!0),x({url:f.stripURLProtocol(CtBuilderAjax.ajaxUrl),method:"POST",params:e,transformResponse:!1}).success(function(o,e,t,r){try{var n=JSON.parse(o);if(s(n,i,l,c),n.notRegisteredShortcodes){var a=Object.values(n.notRegisteredShortcodes);f.showErrorModal(0,"Shortcodes present in design but not registered in WordPress: <br/>"+a.join(", ")+". <br/><br/>Saving now will result in this design breaking. Please re-activate the plugins that supply the shortcodes listed above before saving this design.")}}catch(e){console.log(o,e),f.showErrorModal(0,"Error occurred while loading post: "+i,e)}g.hideLoadingOverlay("loadComponentsTree()")}).error(function(e,o,t,r){console.log(e,o)}).then(null,function(e){f.showErrorModal(e.status,"Error occurred while loading post: "+i,e.statusText,e.config.url)})},f.renderInnerContent=function(s,e){var o=CtBuilderAjax.permalink,t={};o="term"===f.previewType?(t.term=f.template.postData.term,f.template.postData&&f.template.postData.permalink?f.template.postData.permalink:CtBuilderAjax.ajaxUrl):(t.post=f.template.postData,f.template.postData&&f.template.postData.permalink?t.post.permalink:CtBuilderAjax.ajaxUrl);var r={action:"ct_render_innercontent",post_id:CtBuilderAjax.postId,nonce:CtBuilderAjax.nonce};x({url:f.stripURLProtocol(o),method:"POST",params:r,transformResponse:!1}).success(function(e,o,t,r){if(0!==parseInt(e)){var n=f.getComponentById(s);n.html();var a=angular.element("<div>");a.html(e),n.append(a),f.adjustResizeBox()}}).error(function(e,o,t,r){console.log(e,o)}).then(null,function(e){f.showErrorModal(e.status,"Error occurred while rendering innercontent",e.statusText,e.config.url)})},f.evalCondition=function(n){var e;if(void 0===n&&(n=f.component.active.id),0<(e=f.getComponentById(n).closest(".oxy-dynamic-list")).length){var o=e.attr("ng-attr-component-id");f.dynamicListAction(o,n)}else if(f.component.options[n].original&&f.component.options[n].original.conditions&&0<f.component.options[n].original.conditions.length){var t=CtBuilderAjax.permalink,r={};t="term"===f.previewType?(r.term=f.template.postData.term,f.template.postData&&f.template.postData.permalink?f.template.postData.permalink:CtBuilderAjax.permalink):(r.post=f.template.postData,f.template.postData&&f.template.postData.permalink?r.post.permalink:CtBuilderAjax.permalink);var a={action:"ct_eval_condition",post_id:CtBuilderAjax.postId,nonce:CtBuilderAjax.nonce};x({url:f.stripURLProtocol(t),method:"POST",params:a,data:JSON.stringify(f.component.options[n]),transformResponse:!1}).success(function(e,o,t,r){void 0!==(e=JSON.parse(e)).result&&f.setOptionModel("conditionsresult",e.result,n,f.component.options[n].name)}).error(function(e,o,t,r){console.log(e,o),f.adjustResizeBox()}).then(null,function(e){f.showErrorModal(e.status,"Error occurred while evaluation condition",e.statusText,e.config.url)})}else delete iframeScope.component.options[n].model.conditionsresult},f.renderCustomAttributeDynamicData=function(a,s,i){var e=CtBuilderAjax.permalink;f.template.postData&&f.template.postData.permalink&&(e=f.template.postData.permalink);var l=s.match(/\[oxygen[^\]]*\]/gi),c=i.match(/\[oxygen[^\]]*\]/gi),o={action:"oxy_render_attribute_dyanmic_data",post_id:CtBuilderAjax.postId,nonce:CtBuilderAjax.nonce};if(l)var t=s;else t=i;x({url:f.stripURLProtocol(e),method:"POST",params:o,data:t,transformResponse:!1}).success(function(e,o,t,r){(l&&c&&f.renderCustomAttributeDynamicData(a,e,i),l&&!c)&&((n=f.getComponentById(a)).attr&&(RegExp("[^a-z-_]+","gi").test(e)?f.showNoticeModal("<div>"+f.component.options[a].nicename+" Custom Attribute rendered data '"+e+"' is not a valid attribute <b>name</b></div>"):n.attr(e,i),console.log(e,i)));if(!l&&c){var n;if(RegExp("[^a-z-_]+","gi").test(s))return void f.showNoticeModal("<div>"+f.component.options[a].nicename+" Custom Attribute rendered data '"+s+"' is not a valid attribute <b>name</b></div>");(n=f.getComponentById(a)).attr&&(n.attr(s,f.replaceSpecialChars(e)),console.log(s,e))}}).error(function(e,o,t,r){console.log(e,o)})},f.renderShortcode=function(p,e,u,m){if(f.component.options[p]&&f.component.options[p].original&&"true"==f.component.options[p].original.dont_render){f.getComponentById(p).html("")}else{var g=CtBuilderAjax.permalink,o={};g="term"===f.previewType?(o.term=f.template.postData.term,f.template.postData&&f.template.postData.permalink?f.template.postData.permalink:CtBuilderAjax.permalink):(o.post=f.template.postData,f.template.postData&&f.template.postData.permalink?o.post.permalink:CtBuilderAjax.permalink);var y,h={action:"ct_render_shortcode",shortcode_name:e,post_id:CtBuilderAjax.postId,nonce:CtBuilderAjax.nonce},t=f.getComponentById(p),r=!1,n=[];if(t)for(var a=t.parent().closest(".oxy-dynamic-list");a&&0<a.length;)r=parseInt(a.attr("ng-attr-component-id")),f.component.options[r].original.use_acf_repeater?(a=a.parent().closest(".oxy-dynamic-list"),n.push(f.component.options[r].original.acf_repeater)):f.component.options[r].original.use_metabox_clonable_group?(a=a.parent().closest(".oxy-dynamic-list"),n.push(f.component.options[r].original.metabox_group)):(r=parseInt(a.attr("ng-attr-component-id")),a=!1);if(r&&m){var s=f.component.options[r];m.queryOptions={query_args:s.original.query_args,wp_query:f.component.options[r].original.use_acf_repeater||f.component.options[r].original.use_metabox_clonable_group?"default":s.original.wp_query,query_post_ids:s.original.query_post_ids,query_post_types:s.original.query_post_types,query_taxonomies_any:s.original.query_taxonomies_any,query_taxonomies_all:s.original.query_taxonomies_all,query_authors:s.original.query_authors,query_order:s.original.query_order,query_order_by:s.original.query_order_by,query_all_posts:s.original.query_all_posts,query_ignore_sticky_posts:s.original.query_ignore_sticky_posts,query_count:s.original.query_count,wp_query_advanced:s.original.wp_query_advanced},y=JSON.stringify(m.queryOptions),0<n.length&&(f.component.options[r].original.use_acf_repeater&&(m.acfRepeaterFields=n.reverse()),f.component.options[r].original.use_metabox_clonable_group&&(m.metaboxGroupFields=n.reverse()),y+=JSON.stringify(m.repeaterFields))}if(u&&(f.oxygenShortcodesCache=f.oxygenShortcodesCache||[],m&&m.original&&m.original.full_shortcode&&-1<m.original.full_shortcode.indexOf("[oxygen"))){var i=_.findWhere(f.oxygenShortcodesCache,{id:h.post_id,url:g,full_shortcode:m.original.full_shortcode,queryOptions:y});if(i)return void u(m.original.full_shortcode,i.result,i.scripts)}x({url:f.stripURLProtocol(g),method:"POST",params:h,data:m?JSON.stringify(m):JSON.stringify(f.component.options[p]),transformResponse:!1}).success(function(e,o,t,r){if(e||""===e){var n=f.getComponentById(p),a=angular.element("<div>");if(a.html(e),u){f.oxygenShortcodesCache=f.oxygenShortcodesCache||[];var s=a.find("#ct-shortcode-links-scripts").html(),i=a.find("link, script");f.oxygenShortcodesCache.push({id:h.post_id,url:g,full_shortcode:m.original.full_shortcode,queryOptions:y,result:s,scripts:i}),u(m.original.full_shortcode,s,i)}else{n.html(a.find("#ct-shortcode-links-scripts").html());var l=n.closest("body");l.find('link[data-forId="'+p+'"], script[data-forId="'+p+'"]').remove(),a.find("link, script").each(function(){l.append(angular.element(this).attr("data-forId",p))});var c=v(function(){jQuery.ready(),v.cancel(c)},1e3,!1)}var d=new Event("oxygen-ajax-element-loaded");document.dispatchEvent(d)}else console.log(e,o),u&&u(m.original.full_shortcode,""),f.showErrorModal(0,"Error occurred while rendering shortcode");f.adjustResizeBox()}).error(function(e,o,t,r){console.log(e,o),f.adjustResizeBox()}).then(null,function(e){f.showErrorModal(e.status,"Error occurred while rendering shortcode",e.statusText,e.config.url)})}},f.evalConditionsViaAjax=function(e,n){var o=CtBuilderAjax.permalink,t={};o="term"===f.previewType?(t.term=f.template.postData.term,f.template.postData&&f.template.postData.permalink?f.template.postData.permalink:CtBuilderAjax.permalink):(t.post=f.template.postData,f.template.postData&&f.template.postData.permalink?t.post.permalink:CtBuilderAjax.permalink);var r={action:"ct_eval_conditions",post_id:CtBuilderAjax.postId,nonce:CtBuilderAjax.nonce};x({url:f.stripURLProtocol(o),method:"POST",params:r,data:JSON.stringify(e),transformResponse:!1}).success(function(e,o,t,r){e=JSON.parse(e),n&&n(e)}).error(function(e,o,t,r){console.log(e,o)}).then(null,function(e){f.showErrorModal(e.status,"Error occurred while evaluating conditions",e.statusText,e.config.url)})},f.removeChromeModal=function(e){if(e.stopPropagation(),e.preventDefault(),jQuery(e.target).hasClass("ct-chrome-modal-bg")||jQuery(e.target).hasClass("ct-chrome-modal-hide")){var o={action:"ct_remove_chrome_modal",post_id:CtBuilderAjax.postId,nonce:CtBuilderAjax.nonce};x({url:f.stripURLProtocol(CtBuilderAjax.ajaxUrl),method:"POST",params:o,transformResponse:!1}).success(function(e,o,t,r){jQuery(".ct-chrome-modal-bg").remove()}).error(function(e,o,t,r){console.log(e,o)}).then(null,function(e){f.showErrorModal(e.status,"Error occurred while dismissing the notice",e.statusText,e.config.url)})}},f.renderDataComponent=function(a,e){var o=CtBuilderAjax.permalink,t={};o="term"===f.previewType?(t.term=f.template.postData.term,f.template.postData&&f.template.postData.permalink?f.template.postData.permalink:CtBuilderAjax.ajaxUrl):(t.post=f.template.postData,f.template.postData&&f.template.postData.permalink?t.post.permalink:CtBuilderAjax.ajaxUrl);var s={action:"ct_render_data_component",component_name:e,post_id:CtBuilderAjax.postId,nonce:CtBuilderAjax.nonce};x({url:f.stripURLProtocol(o),method:"POST",params:s,data:JSON.stringify(f.component.options[a]),transformResponse:!1}).success(function(e,o,t,r){if(e||""===e){var n=f.getComponentById(a);switch(s.component_name){case"ct_data_featured_image":case"ct_data_author_avatar":e=JSON.parse(e),n[0].src=e.src;break;default:n.html(e)}}else console.log(e,o),f.showErrorModal(0,"Error occurred while rendering the component")}).error(function(e,o,t,r){console.log(e,o)}).then(null,function(e){f.showErrorModal(e.status,"Error occurred while rendering the component",e.statusText,e.config.url)})},f.renderWidget=function(i,l){if("true"!=f.component.options[i].original.dont_render||l){f.log&&console.log("renderWidget()",i,l);var e=JSON.stringify({options:f.component.options[i]}),o=CtBuilderAjax.ajaxUrl,t={post_id:CtBuilderAjax.postId,nonce:CtBuilderAjax.nonce};l?(t.action="ct_render_widget_form",g.cleanInsertUI("<span></span>","#ct-dialog-widget-content"),g.showSidebarLoader=!0):(t.action="ct_render_widget",g.showWidgetOverlay(i),o=f.getAJAXRequestURL()),x({url:f.stripURLProtocol(o),method:"POST",params:t,data:e,transformResponse:!1}).success(function(e,o,t,r){var n=f.getComponentById(i);if(e)if(l){var a=v(function(){g.cleanInsertUI('<form id="ct-widget-form" class="open">'+e+"</form>","#ct-dialog-widget-content"),window.parent.jQuery(window.parent.document).trigger("widget-added",[jQuery("#ct-widget-form",window.parent.document)]),v.cancel(a)},0,!1);g.showSidebarLoader=!1}else{void 0!==window.google&&void 0!==window.google.maps&&"sow-google-map"==f.component.options[i].id.id_base&&delete window.google.maps,n.html(e);a=v(function(){jQuery.ready(),v.cancel(a)},1e3,!1);g.hideWidgetOverlay(i),f.adjustResizeBox()}e&&""!==n.text()||l||n.html("<div class='ct-blank-widget'>Widget Content</div>");var s=new Event("oxygen-ajax-element-loaded");document.dispatchEvent(s)}).error(function(e,o,t,r){f.getComponentById(i).html("<div class='ct-blank-widget'>Widget Content<div>")})}else{f.getComponentById(i).html("")}},f.renderSidebar=function(s,e){var o=JSON.stringify({options:f.component.options[s]}),t={post_id:CtBuilderAjax.postId,nonce:CtBuilderAjax.nonce,action:"ct_render_sidebar"};x({url:f.stripURLProtocol(CtBuilderAjax.ajaxUrl),method:"POST",params:t,data:o,transformResponse:!1}).success(function(e,o,t,r){var n=f.getComponentById(s);e&&n.html(e),e&&""!==n.text()||n.html("<div class='ct-blank-widget'>Sidebar Content</div>");var a=new Event("oxygen-ajax-element-loaded");document.dispatchEvent(a)}).error(function(e,o,t,r){f.getComponentById(s).html("<div class='ct-blank-widget'>Sidebar Content<div>")})},f.renderNavMenu=function(a){void 0===a&&(a=f.component.active.id),f.log&&console.log("renderNavMenu()",a),g.showWidgetOverlay(a);var e=JSON.stringify({options:f.component.options[a]}),o=f.getAJAXRequestURL();params={post_id:CtBuilderAjax.postId,nonce:CtBuilderAjax.nonce,action:"oxy_render_nav_menu"},x({url:f.stripURLProtocol(o),method:"POST",params:params,data:e,transformResponse:!1}).success(function(e,o,t,r){var n=f.getComponentById(a);e?n.html(e):n.html("No menu found"),f.adjustResizeBox(),g.hideWidgetOverlay(a)}).error(function(e,o,t,r){console.log(e,o)}).then(null,function(e){f.showErrorModal(e.status,"Error occurred while rendering menu",e.statusText,e.config.url)})},f.getDynamicDataFromQuery=function(n,e,a,s,o,t,r){void 0===n&&(n=f.component.active.id),f.log&&console.log("getDynamicListData()",action,n);var i=CtBuilderAjax.permalink;if(CtBuilderAjax.oxyTemplate&&!CtBuilderAjax.oxyReusable){if(!f.template.postData||!f.template.postData.permalink)return void f.showErrorModal(0,"Permalink not available for the current post/archive. If it is an archive for a custom post type , make sure that the parameter 'has_archive' for the post type is set to true.");i=f.template.postData.permalink+("/"==f.template.postData.permalink.substr(f.template.postData.permalink.length-1)?"":"/")}else CtBuilderAjax.oxyReusable&&CtBuilderAjax.ctSiteUrl&&(i=CtBuilderAjax.ctSiteUrl+"/");var l={options:f.component.options[n],models:e};if(o){var c=f.component.options[o];l.queryOptions={query_args:c.original.query_args,wp_query:c.original.wp_query,query_post_ids:c.original.query_post_ids,query_post_types:c.original.query_post_types,query_taxonomies_any:c.original.query_taxonomies_any,query_taxonomies_all:c.original.query_taxonomies_all,query_authors:c.original.query_authors,query_order:c.original.query_order,query_order_by:c.original.query_order_by,query_all_posts:c.original.query_all_posts,query_ignore_sticky_posts:c.original.query_ignore_sticky_posts,query_count:c.original.query_count,wp_query_advanced:c.original.wp_query_advanced}}t&&0<t.length&&(l.repeaterFields=t.reverse());l=JSON.stringify(l);var d={post_id:CtBuilderAjax.postId,nonce:CtBuilderAjax.nonce,action:"oxy_get_dynamic_data_query"};g.showWidgetOverlay(n),x({url:f.stripURLProtocol(i),method:"POST",params:d,data:l,transformResponse:!1}).success(function(e,o,t,r){e?(e=JSON.parse(e),a&&a(e.results,s,e.pagination?e.pagination:null)):component.html("No data received"),g.hideWidgetOverlay(n)}).error(function(e,o,t,r){console.log(e,o)}).then(null,function(e){f.showErrorModal(e.status,"Error occurred",e.statusText,e.config.url)})},f.renderComponentWithAJAX=function(s,i){void 0===i&&(i=f.component.active.id);var e=f.getComponentById(i);if(e){var o=e.parents(".oxy-product-builder").attr("ng-attr-component-id");f.log&&console.log("renderComponentWithAJAX()",s,i);var t=f.component.options[i];if(o){var r=f.getOption("oxy-product-builder_product_id",o);t.product_builder_id=r}var n={options:t,component:f.findComponentItem(f.componentsTree.children,i,f.getComponentItem)},a=f.getAJAXRequestURL(),l={post_id:CtBuilderAjax.postId,nonce:CtBuilderAjax.nonce,action:s},c=f.getComponentById(i),d=!1,p=[];if(c)for(var u=c.parent().closest(".oxy-dynamic-list");u&&0<u.length;)d=parseInt(u.attr("ng-attr-component-id")),f.component.options[d].original.use_acf_repeater?(u=u.parent().closest(".oxy-dynamic-list"),p.push(f.component.options[d].original.acf_repeater)):f.component.options[d].original.use_metabox_clonable_group?(u=u.parent().closest(".oxy-dynamic-list"),p.push(f.component.options[d].original.metabox_group)):(d=parseInt(u.attr("ng-attr-component-id")),u=!1);if(d){var m=f.component.options[d];n.queryOptions={query_args:m.original.query_args,wp_query:f.component.options[d].original.use_acf_repeater||f.component.options[d].original.use_metabox_clonable_group?"default":m.original.wp_query,query_post_ids:m.original.query_post_ids,query_post_types:m.original.query_post_types,query_taxonomies_any:m.original.query_taxonomies_any,query_taxonomies_all:m.original.query_taxonomies_all,query_authors:m.original.query_authors,query_order:m.original.query_order,query_order_by:m.original.query_order_by,query_all_posts:m.original.query_all_posts,query_ignore_sticky_posts:m.original.query_ignore_sticky_posts,query_count:m.original.query_count,wp_query_advanced:m.original.wp_query_advanced},0<p.length&&(n.repeaterFields=p.reverse())}g.showWidgetOverlay(i),"oxy_render_easy_posts"==s&&jQuery(".oxygen-easy-posts-ajax-styles-"+i).remove(),x({url:f.stripURLProtocol(a),method:"POST",params:l,data:JSON.stringify(n),transformResponse:!1}).success(function(e,o,t,r){var n=f.getComponentById(i);if(n)if(e){n.removeClass("oxy-ajax-loading");var a=new Event("oxygen-ajax-element-loaded");document.dispatchEvent(a),n.html(e),"oxy_render_easy_posts"==s&&n.find(".oxygen-easy-posts-ajax-styles-"+i).prependTo("head"),f.outputCSSOptions()}else n.html("No data received");else f.showNoticeModal("<div>"+f.component.options[i].nicename+" loading error.</div>");f.adjustResizeBox(),g.hideWidgetOverlay(i)}).error(function(e,o,t,r){console.log(e,o)}).then(null,function(e){f.showErrorModal(e.status,"Error occurred while rendering the component",e.statusText,e.config.url)})}},f.loadSVGIconSets=function(){var e={action:"ct_get_svg_icon_sets",post_id:CtBuilderAjax.postId,nonce:CtBuilderAjax.nonce};x({url:f.stripURLProtocol(CtBuilderAjax.ajaxUrl),method:"POST",params:e,transformResponse:!1}).success(function(o,e,t,r){try{var n=JSON.parse(o);f.SVGSets=n,f.currentSVGSet=Object.keys(n)[0]}catch(e){console.log(o),console.log(e),f.showErrorModal(0,"Error occurred while loading SVG icons")}}).error(function(e,o,t,r){console.log(e,o)}).then(null,function(e){f.showErrorModal(e.status,"Error occurred while loading SVG icons",e.statusText,e.config.url)})},f.loadAttachmentSizes=function(e,n){var o={action:"ct_get_attachment_sizes",post_id:CtBuilderAjax.postId,attachment_id:e,nonce:CtBuilderAjax.nonce};x({url:f.stripURLProtocol(CtBuilderAjax.ajaxUrl),method:"POST",params:o,transformResponse:!1}).success(function(o,e,t,r){try{o=JSON.parse(o)}catch(e){console.log(o),console.log(e),f.showErrorModal(0,"Error occurred while loading attachment sizes")}n(o)}).error(function(e,o,t,r){console.log(e,o)}).then(null,function(e){f.showErrorModal(e.status,"Error occurred while loading attachment sizes",e.statusText,e.config.url)})},f.loadTemplateData=function(a,e,o){o||g.showLoadingOverlay("loadTemplateData()");var t={action:"ct_get_template_data",template_id:CtBuilderAjax.postId,preview_post_id:e,preview_type:f.previewType,post_id:CtBuilderAjax.postId,nonce:CtBuilderAjax.nonce};x({url:f.stripURLProtocol(CtBuilderAjax.ajaxUrl),method:"POST",params:t,transformResponse:!1}).success(function(o,e,t,r){try{var n=JSON.parse(o);a(n)}catch(e){console.log(o),console.log(e),f.showErrorModal(0,"Failed to load template data",e)}g.hideLoadingOverlay("loadTemplateData()")}).error(function(e,o,t,r){console.log(e,o),g.hideLoadingOverlay("loadTemplateData()")}).then(null,function(e){f.showErrorModal(e.status,"Failed to load template data",e.statusText,e.config.url)})},f.loadComponentsTemplates=function(){g.showLoadingOverlay("loadComponentsTemplates()");var e={action:"oxy_get_components_templates",nonce:CtBuilderAjax.nonce,post_id:CtBuilderAjax.postId};x({url:f.stripURLProtocol(CtBuilderAjax.ajaxUrl),method:"POST",params:e,transformResponse:!1}).success(function(o,e,t,r){try{var n=JSON.parse(o);f.componentsTemplates=n}catch(e){console.log(o),console.log(e),f.showErrorModal(0,"Failed to load templates",e),g.hideLoadingOverlay("loadComponentsTemplates()")}if(CtBuilderAjax.ctTemplate)f.loadTemplateData(f.setTemplateData,null,!0);else if(g.hideLoadingOverlay("loadComponentsTemplates()"),f.componentsTree.children){f.buildComponentsFromTree(f.componentsTree.children);!function e(o){o++,setTimeout(function(){0<f.buildingOxygenTreeCounter&&o<180?e(o):(f.classesCached=!1,f.outputCSSOptions(),f.component.id++),0<f.buildingOxygenTreeCounter&&180<=o&&console.log("Tree building timeout. Styles may not be fully applied and Structure panel is not updated.")},500)}(0)}f.waitOxygenTree(function(){f.$emit("oxygen_components_loaded",!0)})}).error(function(e,o,t,r){console.log(e,o),CtBuilderAjax.ctTemplate?f.loadTemplateData(f.setTemplateData,null,!0):(g.hideLoadingOverlay("loadComponentsTemplates()"),f.componentsTree.children&&(f.buildComponentsFromTree(f.componentsTree.children),f.component.id++)),f.waitOxygenTree(function(){f.$emit("oxygen_components_loaded",!1)})}).then(null,function(e){f.showErrorModal(e.status,"Failed to load templates",e.statusText,e.config.url)})},f.loadPostData=function(a,s,i){if(f.postsData[s])a(f.postsData[s],i);else{g.showLoadingOverlay("loadPostData()");var e={action:"ct_get_post_data",id:s,post_id:CtBuilderAjax.postId,nonce:CtBuilderAjax.nonce,preview_post_id:f.template.postData.ID};x({url:f.stripURLProtocol(CtBuilderAjax.ajaxUrl),method:"POST",params:e,transformResponse:!1}).success(function(o,e,t,r){try{var n=JSON.parse(o);a(n,i),f.postsData[s]=n}catch(e){console.log(o),console.log(e),f.showErrorModal(0,"Failed to load post data. ID: "+s,e)}g.hideLoadingOverlay("loadPostData()")}).error(function(e,o,t,r){console.log(e,o),g.hideLoadingOverlay("loadPostData()")}).then(null,function(e){f.showErrorModal(e.status,"Failed to load post data. ID: "+s,e.statusText,e.config.url)})}},f.execCode=function(e,n,a){var o=f.getAJAXRequestURL(),t={code:f.b64EncodeUnicode(e),query:CtBuilderAjax.query};t=JSON.stringify(t),x({method:"POST",transformResponse:!1,url:f.stripURLProtocol(o),params:{action:"ct_exec_code",post_id:CtBuilderAjax.postId,nonce:CtBuilderAjax.nonce},data:t}).success(function(e,o,t,r){0===e.trim().length&&(e=""),-1<e.indexOf("<html")&&(e=jQuery("<div>").append(e).find(".ct-code-block").html()),(e=jQuery("<div>").append(e)).find("script").remove(),e=e.html(),a(e,n)}).error(function(e,o,t,r){console.log(e,o)})},f.getStuffFromSource=function(n,e){void 0===e&&setTimeout(function(){angular.element(".oxygen-sidebar-breadcrumb",window.parent.document).addClass("oxygen-small-progress")},100);var o={action:"ct_new_style_api_call",call_type:"get_stuff_from_source",post_id:CtBuilderAjax.postId,nonce:CtBuilderAjax.nonce};if(0===parseInt(e))return angular.element(".oxygen-sidebar-breadcrumb",window.parent.document).removeClass("oxygen-small-progress"),!1;null!=e&&(o.next=e),x({method:"GET",transformResponse:!1,url:f.stripURLProtocol(CtBuilderAjax.ajaxUrl),params:o}).success(function(e,o,t,r){n(e)}).error(function(e,o,t,r){console.log(e,o)})},f.getComponentsListFromSource=function(i,l,c){setTimeout(function(){angular.element(".oxygen-sidebar-breadcrumb",window.parent.document).addClass("oxygen-small-progress")},200),x({method:"GET",transformResponse:!1,url:f.stripURLProtocol(CtBuilderAjax.ajaxUrl),params:{action:"ct_new_style_api_call",call_type:"get_items_from_source",name:l,post_id:CtBuilderAjax.postId,nonce:CtBuilderAjax.nonce}}).success(function(e,o,t,r){var n=!1;if(e&&""!=e.trim()||(n=!0),n||(e=JSON.parse(e)),n||!e.components)return f.showErrorModal(0,"Items not loaded. "+(e.error?e.error:"Try again!")),void angular.element(".oxygen-sidebar-breadcrumb",window.parent.document).removeClass("oxygen-small-progress");if(angular.element(".oxygen-sidebar-breadcrumb",window.parent.document).removeClass("oxygen-small-progress"),delete f.experimental_components[l].fresh,f.experimental_components[l].items={},_.each(e.components,function(e){var o=e.category;o&&(f.experimental_components[l].items[o]=f.experimental_components[l].items[o]||{},f.experimental_components[l].items[o].slug=btoa(o).replace(/=/g,""),f.experimental_components[l].items[o].contents=f.experimental_components[l].items[o].contents||[],f.experimental_components[l].items[o].contents.push(e))}),CtBuilderAjax.freeVersion&&_.each(f.experimental_components[l].items,function(e,o){var t=Math.round(e.contents.length/10);t<1?t=1:4<t&&(t=4);for(var r=0;r<e.contents.length;r++)e.contents[r].firstFew=r<t?1:0}),f.experimental_components[l].pages=f.experimental_components[l].pages||[],f.experimental_components[l].templates=f.experimental_components[l].templates||[],_.each(e.pages,function(e){"ct_template"===e.type?f.experimental_components[l].templates.push(e):f.experimental_components[l].pages.push(e)}),CtBuilderAjax.freeVersion){var a=Math.round(f.experimental_components[l].pages.length/10);a<1?a=1:4<a&&(a=4);for(var s=0;s<f.experimental_components[l].pages.length;s++)f.experimental_components[l].pages[s].firstFew=s<a?1:0;(a=Math.round(f.experimental_components[l].templates.length/10))<1?a=1:4<a&&(a=4);for(s=0;s<f.experimental_components[l].templates.length;s++)f.experimental_components[l].templates[s].firstFew=s<a?1:0}c(i),angular.element(".oxygen-sidebar-breadcrumb",window.parent.document).removeClass("oxygen-small-progress")}).error(function(e,o,t,r){console.log(e,o),angular.element(".oxygen-sidebar-breadcrumb",window.parent.document).removeClass("oxygen-small-progress")})},f.getPageFromSource=function(e,n,a,s){g.showLoadingOverlay("getPageFromSource()"),x({method:"GET",transformResponse:!1,url:f.stripURLProtocol(CtBuilderAjax.ajaxUrl),params:{action:"ct_new_style_api_call",nonce:CtBuilderAjax.nonce,call_type:"get_page_from_source",id:e,post_id:CtBuilderAjax.postId,source:btoa(n)}}).success(function(e,o,t,r){s(e,n,a),g.hideLoadingOverlay()}).error(function(e,o,t,r){g.hideLoadingOverlay(),console.log(e,o)})},f.getComponentFromSource=function(e,n,a,o,s){g.showLoadingOverlay("getComponentFromSource()"),x({method:"GET",transformResponse:!1,url:f.stripURLProtocol(CtBuilderAjax.ajaxUrl),params:{action:"ct_new_style_api_call",nonce:CtBuilderAjax.nonce,post_id:CtBuilderAjax.postId,call_type:"get_component_from_source",id:e,page:o,source:btoa(n)}}).success(function(e,o,t,r){g.hideLoadingOverlay(),s(e,!1,n,a)}).error(function(e,o,t,r){g.hideLoadingOverlay(),console.log(e,o)})},f.loadedControllers=[],f.loadControlsWithAJAX=function(e){if(!f.loadedControllers[e]){f.loadedControllers[e]=!0,g.showSidebarLoader=!0;var o=CtBuilderAjax.ajaxUrl,t={action:"oxy_load_controls_"+e,post_id:CtBuilderAjax.postId,nonce:CtBuilderAjax.nonce};x({method:"POST",url:f.stripURLProtocol(o),params:t}).success(function(e,o,t,r){e&&g.compileInsertUI(e,"#oxygen-sidebar-control-panel-basic-styles",0),g.showSidebarLoader=!1}).error(function(e,o,t,r){console.log(e,o),g.showSidebarLoader=!1})}},f.loadElementsPresets=function(e){f.elementPresets={},g.showLoadingOverlay("loadElementsPresets()");var o=CtBuilderAjax.ajaxUrl,t={action:"oxy_load_elements_presets",post_id:CtBuilderAjax.postId,nonce:CtBuilderAjax.nonce};x({method:"POST",url:o,params:t}).success(function(e,o,t,r){e?f.elementPresets=e:console.log("No default presets loaded"),g.hideLoadingOverlay("loadElementsPresets()")}).error(function(e,o,t,r){console.log(e,o),g.hideLoadingOverlay("loadElementsPresets()")})},f.getSoundCloudTrackID=function(e){g.showLoadingOverlay("getSoundCloudTrackID()");var o=CtBuilderAjax.ajaxUrl,t={action:"oxy_get_soundcloud_track_id",soundcloud_url:e,post_id:CtBuilderAjax.postId,nonce:CtBuilderAjax.nonce};x({method:"POST",url:f.stripURLProtocol(o),params:t}).success(function(e,o,t,r){e?f.setOptionModel("soundcloud_track_id",e):f.showErrorModal(0,"Error retrieving SoundCloud Track ID. Please check the URL you specified"),g.hideLoadingOverlay()}).error(function(e,o,t,r){console.log(e,o),g.hideLoadingOverlay()})},f.loadConditionsOptions=function(n,e){var o=f.component.active.id,a=iframeScope.component.options[o].model.globalconditions[n].searchValue,t=CtBuilderAjax.ajaxUrl,r={post_id:CtBuilderAjax.postId,nonce:CtBuilderAjax.nonce,action:e,search_value:a};jQuery(".oxygen-select-box-options",g.oxygenUIElement).css({opacity:"0.5",pointerEvents:"none"}),x({method:"POST",url:f.stripURLProtocol(t),params:r}).success(function(e,o,t,r){f.updateConditionOptions(n,e,a),jQuery(".oxygen-select-box-options",g.oxygenUIElement).css({opacity:"",pointerEvents:""})}).error(function(e,o,t,r){console.log(e,o),jQuery(".oxygen-select-box-options",g.oxygenUIElement).css({opacity:"",pointerEvents:""})})},f.getAJAXRequestURL=function(){var e=CtBuilderAjax.permalink;return CtBuilderAjax.oxyTemplate&&(e=f.template.postData&&f.template.postData.permalink?f.addTrailingSlash(f.template.postData.permalink):CtBuilderAjax.oxyReusable?f.addTrailingSlash(CtBuilderAjax.ctSiteUrl)+"?post_id="+CtBuilderAjax.postId:CtBuilderAjax.ajaxUrl),e=e.replace("https:","").replace("http:","")},f.stripURLProtocol=function(e){return e.replace("https:","").replace("http:","")},f.addTrailingSlash=function(e){return(e=e.replace(/\/+$/,""))+"/"},f.setPostEditLockTransient=function(e){var o={action:"set_oxygen_edit_post_lock_transient",post_id:CtBuilderAjax.postId,nonce:CtBuilderAjax.nonce};void 0!==e&&!1===e&&(o.action="unset_oxygen_edit_post_lock_transient"),x({method:"POST",url:f.stripURLProtocol(CtBuilderAjax.ajaxUrl),params:o}).error(function(e,o,t,r){console.log(e,o)})},setInterval(function(){f.setPostEditLockTransient()},1e4)}]);
